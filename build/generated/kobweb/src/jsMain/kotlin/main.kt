...
public fun mainKOBWEB(): Unit {
    handleServerStatusEvents()

    RoutePrefix.set("")
    val router = Router()
    router.register("/") { org.example.empty2.pages.HomePage() }

    com.varabyte.kobweb.silk.initSilkHook = { ctx ->
        org.example.empty2.updateTheme(ctx)
    }
    ...
    renderComposable(rootElementId = "root") {
        CompositionLocalProvider(AppGlobalsLocal provides mapOf("title" to "Empty2")) {
            org.example.empty2.MyApp {
